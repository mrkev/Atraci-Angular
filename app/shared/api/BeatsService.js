app.factory('BeatsService', function () {
    // ===========================================================================
...
// ===========================================================================
    ...
    BeatsAPI.getAudioAsset = function (track_id, cb) {
        cb(null, BASE_URL + BASE_PATH + '/tracks/' + track_id + '/audio' + "?access_token=" );
...
// OAuth 2.0
    BeatsAPI.getCode = function(username, password, clientID, cb) {
        var options = {
    ...
    BeatsAPI.getToken = function(code, cb) {
        var options = {
            code: code,
            redirect_uri: '',
    ...
    BeatsAPI.refreshToken = function(cb) {
        var data = {
    ...
    BeatsAPI.init = function (clientId, clientSecret) {
        CLIENT_ID     = CLIENT_ID ||
        clientId  ||
